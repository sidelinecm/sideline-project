...
const PROVINCE_SEO_DATA = {
  chiangmai: {
    ...
    zones: [
      'นิมมาน', 'สันติธรรม', 'ช้างเผือก', 'เจ็ดยอด', 'แม่โจ้',
      'หางดง', 'สันทราย', 'รวมโชค', 'คูเมือง', 'หลังมอ', 'สารภี', 'แม่ริม'
    ],
    lsi: [
      'รับงานเชียงใหม่', 'สาวไซด์ไลน์เชียงใหม่', 'sideline เชียงใหม่',
      'ไซต์ไลน์เชียงใหม่', 'ไซไลเชียงใหม่', 'นางแบบสาวเหนือ',
      'เพื่อนเที่ยวเชียงใหม่', 'เด็กเอ็นเชียงใหม่', 'น้องๆ รับงานเชียงใหม่',
      'สาวสวยตรงปกเชียงใหม่'
    ],
    intents: [
      'รับงานเอนเตอร์เทน', 'ดูแลแบบเต็มวัน', 'เพื่อนเที่ยวคาเฟ่',
      'N-VIP ชงเหล้า', 'ปาร์ตี้พูลวิลล่า', 'ฟิวแฟนส่วนตัว'
    ],
    traits: [
      'ผิวออร่าสว่าง', 'หน้าหมวยน่ารัก', 'ตัวเล็กสเปคป๋า',
      'หุ่นนางแบบ', 'พูดเหนืออ้อนๆ', 'สัดส่วนเป๊ะ',
      'คุยสนุกเป็นกันเอง', 'แต่งตัวดีดูแพง'
    ],
    hotels: [
      'โรงแรมระดับพรีเมียมแถวนิมมาน',
      'ที่พักใกล้คูเมือง',
      'คอนโดหรูเจ็ดยอด',
      'รีสอร์ทส่วนตัวแม่ริม',
      'โรงแรมบูทีคโซนหางดง'
    ],
    services: [
      'บริการเอนเตอร์เทนส่วนตัว',
      'ดูแลฟิวแฟนเดินนิมมาน',
      'ปาร์ตี้พูลวิลล่าระดับ VIP',
      'เพื่อนเที่ยวผ่อนคลายส่วนตัว',
      'นัดเจอแบบส่วนตัวในโรงแรม'
    ],
    ...
    faqs: [
      {
        q: 'หาน้องๆ รับงานเชียงใหม่ โซนไหนเดินทางสะดวกและเป็นส่วนตัวสุด?',
        a: 'โซนนิมมาน สันติธรรม และเจ็ดยอด เป็นโซนที่น้องๆ พร้อมให้บริการมากที่สุด และมีโรงแรมระดับพรีเมียมรองรับการนัดหมายอย่างปลอดภัย'
      },
      {
        q: 'ความปลอดภัยในการเรียกสาวไซด์ไลน์เชียงใหม่?',
        a: "เราเน้นระบบ 'ไม่โอนมัดจำ' ลูกค้าเจอตัวน้อง จ่ายเงินหน้างานเท่านั้น ป้องกันมิจฉาชีพ 100% พร้อมเก็บข้อมูลลูกค้าเป็นความลับสูงสุด"
      },
      {
        q: 'สามารถนัดน้องๆ ให้มาบริการที่รีสอร์ทส่วนตัวได้ไหม?',
        a: 'ได้แน่นอนครับ น้องๆ ยินดีเดินทางไปดูแลคุณถึงที่พัก เพื่อความเป็นส่วนตัวสูงสุด'
      }
    ]
  },
  ...
  bangkok: {
    ...
    zones: [
      'สุขุมวิท', 'รัชดา', 'ห้วยขวาง', 'ลาดพร้าว', 'สาทร',
      'สีลม', 'ทองหล่อ', 'เอกมัย', 'ปิ่นเกล้า', 'บางนา', 'เลียบด่วน', 'พระราม 9'
    ],
    lsi: [
      'รับงานกรุงเทพ', 'ไซด์ไลน์ กทม', 'สาวไซด์ไลน์กรุงเทพ',
      'sideline bkk', 'พริตตี้ กทม.', 'เด็กเอ็นพรีเมียม',
      'เพื่อนเที่ยวส่วนตัว', 'นางแบบรับงาน', 'ไซด์ไลน์กรุงเทพตรงปก'
    ],
    intents: [
      'เอนเตอร์เทนรายชั่วโมง', 'ดูแลแบบเต็มวัน', 'Private VIP Entertain',
      'เพื่อนเที่ยวทองหล่อ', 'ปาร์ตี้ไพรเวท', 'ฟิวแฟนพรีเมียม'
    ],
    traits: [
      'ลูกคุณหนู', 'ลุคอินเตอร์สายฝอ', 'ใบหน้าเป๊ะ',
      'หุ่นนางแบบ', 'ดูแลเอาใจเก่ง', 'ลุคพนักงานออฟฟิศ',
      'พูดดีมีเสน่ห์', 'แต่งตัวแพง'
    ],
    hotels: [
      'คอนโดหรูติด BTS', 'โรงแรมย่านสุขุมวิท', 'ที่พักพรีเมียมห้วยขวาง',
      'โรงแรมหรูย่านสาทร', 'โรงแรม 5 ดาวย่านสีลม'
    ],
    services: [
      'ดูแลแบบฟิวแฟนเต็มรูปแบบ',
      'เพื่อนเที่ยวกลางคืนทองหล่อ',
      'บริการ N-Vip ส่วนตัว',
      'เอนเตอร์เทนตามคอนโดและโรงแรม',
      'นัดหมายสะดวกใกล้รถไฟฟ้า'
    ],
    ...
    faqs: [
      {
        q: 'น้องๆ รับงานกรุงเทพ ส่วนใหญ่สะดวกโซนไหน?',
        a: 'โซนยอดฮิตคือ รัชดา-ห้วยขวาง และสุขุมวิท-ทองหล่อ นัดหมายตามคอนโดหรือโรงแรมหรูติดรถไฟฟ้าได้สะดวกและเป็นส่วนตัว'
      },
      {
        q: 'เรียกเด็กเอ็น หรือ ไซด์ไลน์ กทม. ต้องมัดจำไหม?',
        a: 'เพื่อความสบายใจสูงสุดของลูกค้า เราใช้ระบบเจอตัวจริงแล้วค่อยชำระเงิน ไม่มีการบังคับโอนมัดจำล่วงหน้าทุกกรณี'
      },
      {
        q: 'มีบริการในโซนเลียบด่วนหรือบางนาไหม?',
        a: 'มีครับ น้องๆ หลายคนสะดวกโซนฝั่งตะวันออกและโซนเมืองชั้นใน สามารถสอบถามคิวได้ก่อนนัดหมาย'
      }
    ]
  },
  ...
  lampang: {
    name: 'ลำปาง',
    geo: { lat: 18.2888, lng: 99.492 },
    zones: [
      'ตัวเมืองลำปาง', 'สวนดอก', 'พระบาท', 'ม.ราชภัฏลำปาง',
      'เกาะคา', 'แม่ทะ', 'น้ำล้อม', 'ท่าคราวน้อย'
    ],
    lsi: [
      'รับงานลำปาง', 'ไซด์ไลน์ลำปาง', 'สาวไซด์ไลน์ลำปาง',
      'sideline ลำปาง', 'ไซต์ไลน์ลำปาง', 'นักศึกษาลำปาง',
      'เพื่อนเที่ยวลำปาง', 'เด็กเอ็นลำปาง'
    ],
    intents: [
      'เอนเตอร์เทนส่วนตัว', 'ดูแลฟิวแฟน', 'เพื่อนเที่ยวชิลๆ',
      'ชงเหล้าปาร์ตี้', 'พักผ่อนแบบเป็นกันเอง'
    ],
    traits: [
      'สาวเหนือหน้าหวาน', 'น่ารักเป็นกันเอง', 'เอาใจเก่ง',
      'ผิวขาวออร่า', 'สัดส่วนดี', 'คุยง่ายอารมณ์ดี'
    ],
    hotels: [
      'โรงแรมในตัวเมืองลำปาง', 'รีสอร์ทส่วนตัวสวนดอก',
      'ที่พักใกล้ราชภัฏ', 'โรงแรมบูทีคโซนพระบาท'
    ],
    services: [
      'บริการเอนเตอร์เทนผ่อนคลาย',
      'ดูแลแบบฟิวแฟน',
      'เพื่อนเที่ยวคาเฟ่ลำปาง',
      'นัดเจอในที่พักหรือโรงแรม'
    ],
    ...
    faqs: [
      {
        q: 'หาไซด์ไลน์ลำปาง นัดเจอโซนไหนได้บ้าง?',
        a: 'น้องๆ ส่วนใหญ่สะดวกในโซนตัวเมืองลำปาง, สวนดอก, และใกล้เคียงสถานศึกษา นัดหมายตามโรงแรมหรือที่พักส่วนตัวได้สะดวก'
      },
      {
        q: 'รับประกันความตรงปกและการบริการไหม?',
        a: 'โปรไฟล์น้องๆ ทุกคนผ่านการคัดกรอง ยืนยันตัวตนแล้วว่าตรงปก และเน้นมารยาทการบริการระดับพรีเมียม เพื่อให้คุณประทับใจที่สุด'
      },
      {
        q: 'มีบริการนอกตัวเมืองไหม?',
        a: 'มีในบางกรณีครับ สามารถแจ้งโซนที่ต้องการล่วงหน้าเพื่อเช็กความสะดวกของน้องๆ'
      }
    ]
  },
  ...
  chiangrai: {
    ...
    zones: [
      'ตัวเมืองเชียงราย', 'บ้านดู่', 'ม.แม่ฟ้าหลวง',
      'ม.ราชภัฏเชียงราย', 'หอนาฬิกา', 'ริมกก', 'สันโค้งหลวง'
    ],
    lsi: [
      'รับงานเชียงราย', 'ไซด์ไลน์เชียงราย', 'สาวไซด์ไลน์เชียงราย',
      'sideline เชียงราย', 'น้องนักศึกษาเชียงราย', 'เด็กเอ็นเชียงราย',
      'สาวสวยเชียงราย'
    ],
    intents: [
      'เพื่อนเที่ยวคาเฟ่เชียงราย', 'เอนเตอร์เทนปาร์ตี้',
      'ดูแลฟิวแฟนส่วนตัว', 'ชิลๆ แบบเป็นกันเอง'
    ],
    traits: [
      'ลุคคุณหนูเชียงราย', 'ขาวเนียนน่ารัก', 'คุยเก่งอารมณ์ดี',
      'โปรไฟล์ดีตรงปก', 'บุคลิกสุภาพ'
    ],
    hotels: [
      'โรงแรมหรูริมกก', 'ที่พักย่านบ้านดู่',
      'รีสอร์ทส่วนตัวตัวเมือง', 'โรงแรมบูทีคใกล้หอนาฬิกา'
    ],
    services: [
      'เอนเตอร์เทนพรีเมียมเชียงราย',
      'เพื่อนเที่ยวดูหนัง',
      'บริการดูแลฟิวแฟน',
      'นัดหมายในตัวเมืองและโซนมหาวิทยาลัย'
    ],
    ...
    faqs: [
      {
        q: 'หาไซด์ไลน์เชียงราย โซนบ้านดู่ นัดยากไหม?',
        a: 'โซนบ้านดู่และใกล้ มฟล. เป็นย่านยอดฮิตที่มีน้องๆ พร้อมให้บริการมากที่สุด นัดหมายง่ายและรวดเร็ว'
      },
      {
        q: 'ระบบการจ่ายเงินเป็นอย่างไร?',
        a: 'เน้นความปลอดภัยสูงสุด จ่ายหน้างานหลังจากเจอตัวน้องแล้วเท่านั้น 100% ไม่มีมัดจำ'
      },
      {
        q: 'มีน้องๆ สายคาเฟ่หรือท่องเที่ยวไหม?',
        a: 'มีครับ สามารถเลือกตามสไตล์ที่ชอบ ทั้งชิลๆ ดูหนัง หรือเที่ยวคาเฟ่'
      }
    ]
  },
  ...
  khonkaen: {
    ...
    zones: [
      'มข.', 'กังสดาล', 'หลังมอ', 'เซ็นทรัลขอนแก่น',
      'บึงแก่นนคร', 'โนนม่วง', 'ศิลา', 'ถนนมิตรภาพ'
    ],
    lsi: [
      'รับงานขอนแก่น', 'ไซด์ไลน์ขอนแก่น', 'สาวไซด์ไลน์ขอนแก่น',
      'sideline ขอนแก่น', 'เด็กเอ็นขอนแก่น', 'นักศึกษาขอนแก่น',
      'เพื่อนเที่ยวขอนแก่น'
    ],
    intents: [
      'N-Vip ขอนแก่น', 'เพื่อนเที่ยวกลางคืน', 'ดูแลแบบฟิวแฟน',
      'ทานข้าวดูหนัง', 'เอนเตอร์เทนส่วนตัว'
    ],
    traits: [
      'สาวอีสานผิวขาว', 'หน้าตาน่ารักหมวย', 'หุ่นเพรียวสัดส่วนดี',
      'พูดจาเพราะ', 'อัธยาศัยดี', 'คุยสนุก'
    ],
    hotels: [
      'โรงแรมหรูใกล้เซ็นทรัล', 'ที่พักย่านกังสดาล',
      'คอนโดหรูหลังมอ', 'โรงแรมตัวเมืองขอนแก่น'
    ],
    services: [
      'เอนเตอร์เทนครบวงจร',
      'เพื่อนกินข้าว-ดูหนัง',
      'ฟิวแฟนระดับ VIP',
      'นัดหมายตามคอนโดและโรงแรม'
    ],
    avgPrice: '1,500 - 4,000',
    ...
    faqs: [
      {
        q: 'น้องๆ ไซด์ไลน์ขอนแก่น ส่วนใหญ่เป็นใคร?',
        a: 'เรามีทั้งน้องๆ นักศึกษาพาร์ทไทม์ และนางแบบพริตตี้ที่รับงานส่วนตัว ซึ่งผ่านการคัดโปรไฟล์มาอย่างดี'
      },
      {
        q: 'นัดหมายในขอนแก่นต้องทำอย่างไร?',
        a: 'เลือกน้องที่ถูกใจ ทักสอบถามคิว และนัดเจอในจุดที่เป็นส่วนตัว จ่ายเงินหน้างานสะดวกที่สุด'
      },
      {
        q: 'โซนไหนนัดง่ายสุด?',
        a: 'โซนกังสดาล, หลังมอ, และรอบมหาวิทยาลัยมักนัดได้สะดวกที่สุด'
      }
    ]
  },
  ...
  chonburi: {
    ...
    zones: [
      'พัทยา', 'บางแสน', 'ศรีราชา', 'อมตะนคร',
      'ตัวเมืองชลบุรี', 'ม.บูรพา', 'แหลมฉบัง'
    ],
    lsi: [
      'รับงานชลบุรี', 'ไซด์ไลน์ชลบุรี', 'สาวไซด์ไลน์พัทยา',
      'sideline ชลบุรี', 'เพื่อนเที่ยวบางแสน', 'เด็กเอ็นพัทยา',
      'รับงานพัทยา'
    ],
    intents: [
      'ปาร์ตี้ริมหาด', 'พูลวิลล่าพัทยา', 'ดูแลฟิวแฟนท่องเที่ยว',
      'N-Vip ชลบุรี', 'ทริปทะเลส่วนตัว'
    ],
    traits: [
      'ผิวแทนเซ็กซี่', 'หุ่นนางแบบ', 'อินเตอร์ลุค',
      'เอาใจเก่งมาก', 'สายลุยไปไหนไปกัน', 'มั่นใจและมีเสน่ห์'
    ],
    hotels: [
      'โรงแรมหรูริมหาดพัทยา',
      'คอนโดหรูบางแสน',
      'รีสอร์ทส่วนตัวศรีราชา',
      'โรงแรมติดทะเลพัทยา'
    ],
    services: [
      'เพื่อนเที่ยวทะเล',
      'เอนเตอร์เทนพูลวิลล่า',
      'ดูแล VIP ส่วนตัว',
      'นัดหมายตามโรงแรมและบ้านพัก'
    ],
    ...
    faqs: [
      {
        q: 'หาสาวไซด์ไลน์พัทยา-บางแสน ตรงปกไหม?',
        a: 'เราเน้นการตรวจสอบรูปภาพให้ตรงกับตัวจริงที่สุด เพื่อให้ลูกค้าประทับใจและกลับมาใช้บริการซ้ำ'
      },
      {
        q: 'น้องๆ รับงานพูลวิลล่าไหม?',
        a: 'มีน้องๆ สายปาร์ตี้ที่เชี่ยวชาญการเอนเตอร์เทนในพูลวิลล่าโดยเฉพาะ พร้อมให้บริการในชลบุรีและพัทยา'
      },
      {
        q: 'จองนอกสถานที่ได้ไหม?',
        a: 'ได้ครับ สามารถสอบถามโซนพักและรูปแบบงานก่อนนัดหมาย'
      }
    ]
  },
  ...
  ubonratchathani: {
    name: 'อุบลราชธานี',
    geo: { lat: 15.2293, lng: 104.857 },
    zones: [
      'ตัวเมืองอุบล', 'วารินชำราบ', 'ม.อุบล',
      'เซ็นทรัลอุบล', 'ทุ่งศรีเมือง', 'ราชธานี', 'ขามใหญ่'
    ],
    lsi: [
      'รับงานอุบล', 'ไซด์ไลน์อุบล', 'สาวไซด์ไลน์อุบล',
      'sideline อุบล', 'เด็กเอ็นอุบล', 'เพื่อนเที่ยวอุบล'
    ],
    intents: [
      'เอนเตอร์เทนส่วนตัว', 'ดูแลฟิวแฟน', 'เพื่อนเที่ยวงานเทศกาล',
      'ทานข้าวดูหนัง'
    ],
    traits: [
      'สาวอีสานหน้าหวาน', 'เรียบร้อยน่ารัก', 'พูดจาดีเอาใจเก่ง',
      'ผิวเนียนสวย', 'สุภาพเรียบร้อย'
    ],
    hotels: [
      'โรงแรมในตัวเมืองอุบล',
      'ที่พักย่านวาริน',
      'โรงแรมหรูใกล้เซ็นทรัล'
    ],
    services: [
      'บริการเอนเตอร์เทนแบบเป็นกันเอง',
      'ดูแลฟิวแฟนกินข้าวดูหนัง',
      'นัดหมายงานส่วนตัวในเมือง'
    ],
    avgPrice: '1,500 - 3,000',
    ...
    faqs: [
      {
        q: 'ไซด์ไลน์อุบล นัดเจอแถวไหนสะดวก?',
        a: 'โซนตัวเมืองและใกล้ห้างเซ็นทรัลอุบล เป็นจุดนัดพบที่สะดวกและปลอดภัยที่สุด'
      },
      {
        q: 'มีการคัดกรองน้องๆ อย่างไร?',
        a: 'เราคัดเลือกเฉพาะน้องๆ ที่มีใจรักงานบริการและมีตัวตนจริงเท่านั้น เพื่อคุณภาพสูงสุด'
      },
      {
        q: 'มีงานแบบฟิวแฟนไหม?',
        a: 'มีครับ ทั้งทานข้าว ดูหนัง และไปคาเฟ่แบบเป็นกันเอง'
      }
    ]
  },
  ...
  udonthani: {
    name: 'อุดรธานี',
    geo: { lat: 17.398, lng: 102.7931 },
    zones: [
      'ตัวเมืองอุดร', 'ยูดีทาวน์', 'เซ็นทรัลอุดร',
      'หนองประจักษ์', 'ราชภัฏอุดร', 'บ้านจั่น'
    ],
    lsi: [
      'รับงานอุดร', 'ไซด์ไลน์อุดร', 'สาวไซด์ไลน์อุดร',
      'sideline อุดร', 'เด็กเอ็นอุดร', 'พริตตี้อุดร', 'เพื่อนเที่ยวอุดร'
    ],
    intents: [
      'เพื่อนเที่ยว VIP อุดร', 'ดูแลฟิวแฟนเอนเตอร์เทน',
      'N-Vip ปาร์ตี้', 'ทริปคาเฟ่', 'ชิลๆ แบบส่วนตัว'
    ],
    traits: [
      'ลุคอินเตอร์หน้าเป๊ะ', 'ขาวสวยออร่า', 'แต่งตัวเก่ง',
      'บุคลิกดีระดับพริตตี้', 'คุยสนุก', 'เอาใจเก่ง'
    ],
    hotels: [
      'โรงแรมหรูใกล้ยูดีทาวน์',
      'ที่พักพรีเมียมตัวเมือง',
      'โรงแรมใกล้เซ็นทรัล',
      'โรงแรมบูทีคหนองประจักษ์'
    ],
    services: [
      'บริการดูแลระดับ Exclusive',
      'เพื่อนเที่ยวกลางคืนยูดีทาวน์',
      'เอนเตอร์เทนส่วนตัว',
      'นัดหมายตามโรงแรมและคอนโด'
    ],
    avgPrice: '1,500 - 4,000',
    ...
    faqs: [
      {
        q: 'หาเด็กเอ็นอุดร ย่านไหนตัวท็อปเยอะ?',
        a: 'ย่านยูดีทาวน์และเซ็นทรัลอุดร เป็นแหล่งรวมน้องๆ งานดีระดับพรีเมียม'
      },
      {
        q: 'จองน้องๆ อุดรธานี ต้องทำอย่างไร?',
        a: 'ทักแชทสอบถามคิวงานน้องที่สนใจ นัดเวลาและสถานที่ จ่ายเงินเมื่อพบตัวน้องจริงเท่านั้น'
      },
      {
        q: 'มีงานแบบไปดื่มคาเฟ่ไหม?',
        a: 'มีครับ น้องๆ บางคนถนัดสายชิล สามารถนัดคาเฟ่หรือทานข้าวได้'
      }
    ]
  },
  ...
  phitsanulok: {
    ...
    zones: [
      'ตัวเมืองพิษณุโลก', 'ม.นเรศวร', 'ริมน้ำน่าน',
      'เซ็นทรัลพิษณุโลก', 'วัดใหญ่', 'อรัญญิก'
    ],
    lsi: [
      'รับงานพิษณุโลก', 'ไซด์ไลน์พิษณุโลก', 'สาวไซด์ไลน์พิษณุโลก',
      'sideline พิษณุโลก', 'น้องนักศึกษามน', 'เด็กเอ็นพิษณุโลก'
    ],
    intents: [
      'เพื่อนเที่ยวคาเฟ่', 'ดูแลฟิวแฟนทานข้าว',
      'เอนเตอร์เทนส่วนตัว', 'ทริปกลางคืน'
    ],
    traits: [
      'สาวสองแควหน้าหวาน', 'น่ารักสไตล์นักศึกษา',
      'พูดเพราะเป็นกันเอง', 'ดูแลเอาใจใส่เก่ง'
    ],
    hotels: [
      'โรงแรมหรูในเมือง', 'ที่พักใกล้ ม.นเรศวร',
      'โรงแรมริมน้ำน่าน', 'คอนโดตัวเมือง'
    ],
    services: [
      'บริการเอนเตอร์เทนแบบฟิวแฟน',
      'เพื่อนเที่ยว-ดูหนัง',
      'นัดหมายในตัวเมืองและรอบมหาวิทยาลัย'
    ],
    avgPrice: '1,500 - 3,000',
    ...
    faqs: [
      {
        q: 'หาไซด์ไลน์พิษณุโลก แถว มน. นัดยากไหม?',
        a: 'โซน ม.นเรศวร (มน.) มีน้องๆ นักศึกษาพาร์ทไทม์รับงานเยอะ นัดหมายได้สะดวกและรวดเร็วมาก'
      },
      {
        q: 'ต้องจ่ายเงินมัดจำก่อนไหม?',
        a: 'เพื่อความมั่นใจของลูกค้า เราไม่มีนโยบายโอนเงินก่อน จ่ายเงินหน้างานเท่านั้นครับ'
      },
      {
        q: 'มีน้องๆ สายคาเฟ่หรือเปล่า?',
        a: 'มีครับ สามารถเลือกน้องแนวคุยสนุกหรือคาเฟ่ชิลๆ ได้'
      }
    ]
  },
  ...
  default: {
    ...
    geo: { lat: 13.7563, lng: 100.5018 },
    zones: [
      'ตัวเมือง', 'พื้นที่ใกล้เคียง', 'โซนยอดฮิต',
      'โรงแรมชั้นนำ', 'คอนโดหรู', 'ย่านธุรกิจ'
    ],
    lsi: [
      'รับงานส่วนตัว', 'สาวไซด์ไลน์', 'sideline พรีเมียม',
      'เพื่อนเที่ยว', 'เด็กเอ็น', 'นักศึกษาพาร์ทไทม์',
      'สาวสวยตรงปก', 'ดูแลฟิวแฟน', 'น้องๆ รับงาน'
    ],
    intents: [
      'รับงานเอนเตอร์เทน', 'ดูแลแบบเต็มวัน',
      'เพื่อนเที่ยว', 'ฟิวแฟน', 'พักผ่อนแบบส่วนตัว'
    ],
    traits: [
      'หน้าตาน่ารัก', 'บุคลิกดี', 'เอาใจเก่ง',
      'บริการประทับใจ', 'คุยง่าย', 'ตรงปก'
    ],
    hotels: [
      'โรงแรมในตัวเมือง',
      'รีสอร์ทส่วนตัว',
      'คอนโดหรือที่พักพรีเมียม'
    ],
    services: [
      'ฟิวแฟนส่วนตัว',
      'เพื่อนเที่ยว-ดูหนัง',
    ...
    faqs: [
      {
        q: 'ใช้บริการน้องๆ รับงาน ต้องโอนมัดจำล่วงหน้าไหม?',
        a: 'ไม่มีการโอนมัดจำใดๆ ทั้งสิ้น ลูกค้าจ่ายเงินสดหน้างานเมื่อเจอตัวน้องจริงเท่านั้น เพื่อความปลอดภัยสูงสุดของคุณ'
      },
      {
        q: 'รับประกันความตรงปกไหม?',
        a: 'รูปโปรไฟล์ทุกรูปผ่านการคัดกรอง ยืนยันตัวตนแล้วว่าตรงปกและพร้อมให้บริการระดับพรีเมียมอย่างแท้จริง'
      },
      {
        q: 'มีโซนไหนนัดง่ายเป็นพิเศษ?',
        a: 'โซนตัวเมืองและโรงแรมพรีเมียมมักเป็นจุดที่นัดหมายได้สะดวกที่สุด'
      }
    ]
  }
};
...
const generateAppSeoText = (provinceName, provinceKey, count) => {
  ...
  const termsAndConditions = [
    {
      t: 'การจองคิวงานส่วนตัว',
      d: 'เพื่อความเป็นส่วนตัวสูงสุด สมาชิก 1 ท่าน ควรจองคิวงานทีละ 1 คิวเท่านั้น'
    },
    {
      t: 'ความปลอดภัยทางการเงิน',
      d: 'ควรชำระเงินหน้างานเมื่อพบตัวจริง และหลีกเลี่ยงการโอนเงินก่อน'
    },
    {
      t: 'การตรวจสอบโปรไฟล์',
      d: 'โปรไฟล์ทั้งหมดควรผ่านการตรวจสอบรูปภาพและข้อมูลก่อนเผยแพร่'
    },
    {
      t: 'การรักษาความเป็นส่วนตัว',
      d: 'ข้อมูลการนัดหมายและข้อมูลส่วนตัวควรถูกเก็บเป็นความลับ'
    }
  ];
...
<section class="mt-8 px-4 space-y-8 pb-10">
  <div class="max-w-4xl mx-auto space-y-6">
    <div class="cyber-glass rounded-2xl p-6 md:p-8 border border-3D1A5F">
      <h2 class="text-xl md:text-2xl font-bold text-white mb-3">
        ไซด์ไลน์${escapeHTML(provinceName)} พร้อมดูแลคุณ
      </h2>
      <p class="text-zinc-300 leading-relaxed">
        รวมโปรไฟล์ในพื้นที่ ${escapeHTML(provinceName)} พร้อมข้อมูลที่อัปเดตล่าสุด ${safeCount} รายการ
        เพื่อช่วยให้คุณเลือกได้ง่ายขึ้นและตรงความต้องการมากขึ้น
      </p>
    </div>

    <div class="cyber-glass rounded-2xl p-6 md:p-8 border border-3D1A5F">
      <h3 class="text-lg md:text-xl font-bold text-white mb-4">ทำไมต้องเลือกเรา</h3>
      <ul class="space-y-3 text-zinc-300">
        ${termsAndConditions
          .map(
            (item) => `
            <li class="flex gap-3">
              <span class="text-FF007F font-bold">•</span>
              <div>
                <div class="font-semibold text-white">${escapeHTML(item.t)}</div>
                <div class="text-sm leading-relaxed">${escapeHTML(item.d)}</div>
              </div>
            </li>`
          )
          .join('')}
    ...
    <div class="cyber-glass rounded-2xl p-6 md:p-8 border border-3D1A5F">
      <h3 class="text-lg md:text-xl font-bold text-white mb-4">พื้นที่ยอดนิยม</h3>
      <div class="flex flex-wrap gap-2">
        ${(data.zones || []).map((zone) => `
          <span class="px-3 py-1 rounded-full bg-white10 text-white text-xs border border-white20">
            ${escapeHTML(zone)}
          </span>
        `).join('')}
      </div>
...
const buildSchemaData = ({ provinceName, provinceUrl, title, description, firstImage, seoData, count }) => ({
  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Locations', item: `${CONFIG.DOMAIN}/locations.html` },
        { '@type': 'ListItem', position: 3, name: provinceName, item: provinceUrl }
      ]
    },
    {
      '@type': 'LocalBusiness',
      '@id': `${provinceUrl}#business`,
      name: `${provinceName} - ${CONFIG.BRAND_NAME}`,
      image: firstImage,
      description,
      url: provinceUrl,
      address: {
      ...
      aggregateRating: count > 0 ? {
        ...
        ratingValue: 4.8,
        reviewCount: String(Math.max(count * 3, 12)),
        bestRating: 5,
        worstRating: 1
      } : undefined
    },
...
const renderProfileCard = (p, i, provinceName, seoData) => {
  const rawName = String(p.name || 'ไม่ระบุชื่อ').replace(/^(น้อง\s?)/, '').trim();
  const cleanName = escapeHTML(rawName || 'ไม่ระบุชื่อ');
  const profileLocation = escapeHTML(p.location || provinceName || 'ไม่ระบุโซน');
  const slug = escapeHTML(p.slug || p.id || '');
  const profileLink = `/sideline/${slug}`;

  const availability = String(p.availability || '').toLowerCase();
  const isAvailable = !['ติดจอง', 'ไม่ว่าง', 'พัก', 'หยุด', 'busy', 'closed', 'offline'].some((kw) =>
    availability.includes(kw)
  );

  let displayRate = 'สอบถาม';
  if (p.rate !== null && p.rate !== undefined && String(p.rate).trim() !== '') {
    const cleanRateValue = String(p.rate).replace(/,/g, '').trim();
    const numRate = Number(cleanRateValue);
    if (!Number.isNaN(numRate) && cleanRateValue !== '') {
      displayRate = numRate.toLocaleString('th-TH');
    } else {
      displayRate = escapeHTML(String(p.rate));
    }
  }
...
const renderEmptyState = (provinceName) => `
<div class="col-span-full flex flex-col items-center justify-center py-20 md:py-32 text-center cyber-glass rounded-[2rem] border border-[#3D1A5F]/50">
  ...
  <p class="text-zinc-228 text-sm md:text-base max-w-md mx-auto leading-relaxed">
    ขณะนี้กำลังจัดเตรียมโปรไฟล์น้องๆ ระดับ VIP ในโซน <strong class="text-white">${escapeHTML(provinceName)}</strong><br/>
    กรุณากลับมาตรวจสอบใหม่อีกครั้งในภายหลัง
  </p>
  ...
  try {
    ...
    const [provinceRes, profilesRes, allProvincesRes] = await Promise.all([
      ...
      supabase.from('profiles')
        .select('id, slug, name, imagePath, location, rate, isfeatured, lastUpdated, active, availability')
    ...
    const firstImage = profiles.length > 0
      ? optimizeImg(profiles[0].imagePath, 1200, 630)
      : `${CONFIG.DOMAIN}/images/seo-default.webp`;

    const title = `ไซด์ไลน์${provinceName} (${profiles.length > 0 ? `${profiles.length}+ คน` : 'เกรดพรีเมียม'}) รับงานเด็กเอ็น VIP ไม่ต้องมัดจำ`;
    const description = `รวมน้องๆ รับงาน${provinceName} และไซด์ไลน์${provinceName} ระดับ VIP ${profiles.length} โปรไฟล์ โซน ${(seoData.zones || ['ตัวเมือง']).slice(0, 3).join(', ')} และอีกมากมาย ✓การันตีตรงปก 100% ✓ไม่บังคับโอนมัดจำ ✓จ่ายเงินสดหน้างานเท่านั้น`;

    const priceParts = String(seoData.avgPrice || '1,500 - 3,500').split('-');
    ...
    if (profiles.length > 0) {
      cardsHTML = profiles.map((p, i) => renderProfileCard(p, i, provinceName, seoData)).join('');
    } else {
      cardsHTML = renderEmptyState(provinceName);
    }

    return await (async () => {
      const seoSection = generateAppSeoText(provinceName, provinceKey, profiles.length);
  ...
  <main class="w-full relative z-20">
    <section class="px-4 pb-10">
      <div class="max-w-7xl mx-auto">
        <div id="profiles-grid" class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6">
          ${cardsHTML}
        </div>
      </div>
    </section>
    ...
    return new Response(`<div style="font-family:sans-serif;text-align:center;padding:50px;color:#fff;background:#0A0014;height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center">
      <div style="width:50px;height:50px;border:3px solid #3D1A5F;border-top-color:#FF007F;border-radius:50%;animation:spin 1s linear infinite;margin-bottom:15px;box-shadow:0 0 15px rgba(255,0,127,0.5)"></div>
      <style>@keyframes spin { 100% { transform: rotate(360deg); } }</style>
      <h1 style="font-size:18px;font-weight:bold;color:#FF007F;text-shadow:0 0 10px rgba(255,0,127,0.5);letter-spacing:2px;font-family:Orbitron, sans-serif">SYSTEM INITIALIZING</h1>
    </div>`, {
      status: 500,
...
<body class="antialiased flex flex-col min-h-screen pb-safe md:pb-0">
    ...
    <nav aria-label="เมนูหลัก" class="fixed top-0 w-full z-50 pt-safe transition-transform duration-300" id="navbar" style="background: rgba(10, 0, 20, 0.85); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); border-bottom: 1px solid #3D1A5F; box-shadow: 0 4px 30px rgba(0, 0, 0, 0.5);">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 md:h-20 flex items-center justify-between">
            <a href="/" class="flex items-center" aria-label="หน้าหลัก ${escapeHTML(CONFIG.BRAND_NAME)}">
                <img src="/images/logo-sidelinechiangmai.webp" alt="โลโก้ ${escapeHTML(CONFIG.BRAND_NAME)}" width="168" height="28" class="h-[24px] md:h-[30px] w-auto brightness-200" style="filter: drop-shadow(0 0 8px rgba(255,0,127,0.5));">
            </a>
        ...
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12 relative z-10">
            <div class="flex-1 text-center lg:text-left z-10 animate-fade-in-up">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full cyber-glass text-[10px] md:text-xs font-semibold text-white uppercase tracking-widest mb-4 md:mb-6 font-orbitron shadow-[0_0_10px_rgba(255,0,127,0.2)]">
                    <span class="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#FF007F] animate-pulse shadow-[0_0_8px_#FF007F]" aria-hidden="true"></span> ${escapeHTML(CONFIG.BRAND_NAME)}
                </div>
            ...
            <div class="flex-1 w-full max-w-md lg:max-w-full animate-scale-in">
                <div class="relative rounded-[2rem] md:rounded-[2.5rem] overflow-hidden aspect-[4/5] md:aspect-square border border-[#3D1A5F] shadow-[0_0_40px_rgba(255,0,127,0.2)] group">
                    ...
                    <div class="absolute bottom-5 left-5 right-5 md:bottom-8 md:left-8 md:right-8 cyber-glass rounded-2xl p-4 flex items-center gap-4">
                        <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#00F3FF] flex items-center justify-center text-[#0A0014] shadow-[0_0_15px_rgba(0,243,255,0.8)]">
                            <i class="fas fa-shield-check text-lg md:text-xl" aria-hidden="true"></i>
                        </div>
                        <div>
    ...
    <main class="w-full relative z-20">
        <nav aria-label="ตัวกรองและหมวดหมู่" class="sticky top-14 md:top-20 z-40 bg-[#0A0014]/90 backdrop-blur-xl border-y border-[#3D1A5F] py-2.5 md:py-3 px-4 shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
            <div class="max-w-7xl mx-auto flex overflow-x-auto no-scrollbar gap-2.5 items-center snap-x">
                ...
                <button aria-label="กรองโปรไฟล์มาแรง" class="snap-start shrink-0 cyber-glass text-white px-5 py-2 rounded-full text-xs font-medium whitespace-nowrap hover:shadow-[0_0_15px_rgba(255,0,127,0.4)] hover:border-[#FF007F] transition-all flex items-center gap-1.5">
                    <i class="fas fa-fire text-[#FF007F]" aria-hidden="true"></i> มาแรง
                </button>
                <button aria-label="เลือกโซนให้บริการ" class="snap-start shrink-0 cyber-glass text-white px-5 py-2 rounded-full text-xs font-medium whitespace-nowrap hover:shadow-[0_0_15px_rgba(112,0,255,0.4)] hover:border-[#7000FF] transition-all flex items-center gap-1.5">
                    <i class="fas fa-map-marker-alt text-[#7000FF]" aria-hidden="true"></i> เลือกโซน <i class="fas fa-chevron-down text-[10px] ml-1 opacity-50" aria-hidden="true"></i>
                </button>
        ...
        <section id="profiles-grid" aria-label="รายการโปรไฟล์น้องๆ" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 scroll-mt-24">
            ...
            <div class="profiles-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-5 lg:gap-6">
                ${cardsHTML}
            </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <section class="px-4 pb-16">
                <div class="max-w-4xl mx-auto cyber-glass rounded-2xl p-6 md:p-8 border border-[#3D1A5F]">
                    <h2 class="text-2xl font-black text-white mb-6 text-neon-cyan">คำถามที่พบบ่อย</h2>
                    <div id="faq-accordion" class="space-y-3">
                        ${(seoData.faqs || []).map((item, idx) => `
                            <div class="faq-item rounded-xl border border-white/10 overflow-hidden" aria-expanded="${idx === 0 ? 'true' : 'false'}">
                                <button type="button" class="faq-question w-full flex items-center justify-between gap-4 p-4 text-left bg-black/20">
                                    <span class="font-semibold text-white">${escapeHTML(item.q)}</span>
                                    <i class="fas fa-chevron-down transition-transform"></i>
                                </button>
                                <div class="faq-answer overflow-hidden">
                                    <div class="p-4 pt-0 text-zinc-300 leading-relaxed">${escapeHTML(item.a)}</div>
                                </div>
                            </div>
                        `).join('')}
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
                <div class="md:col-span-5 space-y-5">
                    <img src="/images/logo-sidelinechiangmai.webp" alt="โลโก้ ${escapeHTML(CONFIG.BRAND_NAME)}" class="h-8 w-auto brightness-200" width="168" height="28" loading="lazy" style="filter: drop-shadow(0 0 5px rgba(255,0,127,0.3));">
                ...
                <nav aria-label="ลิงก์ส่วนต่างๆ ภายในเว็บ" class="md:col-span-3">
                    ...
                    <ul class="space-y-4 text-sm font-medium text-zinc-300">
                        <li><a href="/profiles.html" class="hover:text-[#FF007F] transition-all">ค้นหาน้องๆ VIP</a></li>
                        <li><a href="/locations.html" class="hover:text-[#FF007F] transition-all">โซนให้บริการ</a></li>
                        <li><a href="/faq.html" class="hover:text-[#FF007F] transition-all">ขั้นตอนการจอง</a></li>
                        <li><a href="/about.html" class="hover:text-[#FF007F] transition-all">เกี่ยวกับเรา</a></li>
                        <li><a href="/blog.html" class="hover:text-[#FF007F] transition-all">บทความน่ารู้</a></li>
                    </ul>
                </nav>
                ...
                <nav aria-label="พื้นที่ให้บริการทั้งหมด" class="md:col-span-4">
                    ...
                    <ul class="flex flex-col gap-3 text-sm font-medium text-zinc-100 h-[180px] overflow-y-auto pr-3 custom-scrollbar">
                        ${(allProvinces || []).map(p => `
                            <li>
                                <a href="/location/${escapeHTML(p.key)}" class="hover:text-[#00F3FF] transition-all flex items-center justify-between group">
            ...
            <div class="border-t border-[#3D1A5F] pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
                <p class="text-[10px] md:text-xs text-zinc-100 uppercase tracking-widest font-medium font-orbitron">&copy; ${CURRENT_YEAR} ${escapeHTML(CONFIG.BRAND_NAME)}. All rights reserved.</p>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const contentSections = document.querySelectorAll('.cyber-glass, [class*="rounded-[2.5rem]"]');
