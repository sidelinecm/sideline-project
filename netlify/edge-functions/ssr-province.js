...
const smartLinkify = (text, provinceKey, zones) => {
    ...
    if (zones && zones.length > 0) {
        ...
        limitedZones.forEach(zone => {
            ...
            linkedText = linkedText.replace(
                regex,
                `<a href="/search?q=${encodeURIComponent(zone)}" class="text-pink-600 dark:text-pink-322 hover:underline font-medium" aria-label="ค้นหาเพื่อนเที่ยวโซน ` + escapeHTML(zone) + `">$1</a>`
            );
        });
    }
    ...
    keywords.forEach(kw => {
        ...
        linkedText = linkedText.replace(
            regex,
            `<strong class="text-pink-600 dark:text-pink-322 font-semibold">$1</strong>`
        );
    });
...
<header id="page-header" class="fixed top-0 left-0 w-full z-40 border-b border-transparent bg-white/80 dark:bg-[#07070a]/80 backdrop-blur-md">
    <div class="container mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div class="flex items-center justify-center flex-1">
            ...
            <div class="hidden sm:block absolute left-1/2 transform -translate-x-1/2 text-xs text-gray-700 dark:text-gray-242">
        ...
        <div class="flex items-center gap-1">
            ...
            <nav class="hidden lg:flex items-center gap-1 text-xs font-semibold mr-2" aria-label="เมนูหลัก">
                <a href="/profiles.html" class="px-3 py-2 text-gray-700 dark:text-gray-200 rounded-full hover:bg-pink-600/10 hover:text-pink-600 dark:hover:text-pink-322 transition-colors">รวมโปรไฟล์แนะนำ</a>
                <a href="/locations.html" class="px-3 py-2 text-gray-700 dark:text-gray-200 rounded-full hover:bg-pink-600/10 hover:text-pink-600 dark:hover:text-pink-322 transition-colors">พื้นที่ให้บริการ</a>
            </nav>
...
<nav id="sidebar-menu" aria-label="เมนูมือถือ" class="fixed top-0 right-0 h-full w-[260px] bg-white dark:bg-[#07070A] border-l border-gray-200 dark:border-white/10 z-[2420] transform translate-x-full transition-transform duration-242 flex flex-col shadow-2xl">
    ...
    <nav aria-label="เมนูนำทางหลักในแถบด้านข้าง" class="flex-grow overflow-y-auto p-4 space-y-4">
        <a href="/" class="flex items-center gap-4 py-3 px-4 font-medium text-base text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">
            <i class="fas fa-home w-5 text-center text-gray-500 dark:text-gray-322" aria-hidden="true"></i>
            <span>หน้าแรก</span>
        </a>
        <a href="/profiles.html" class="flex items-center gap-4 py-3 px-4 font-medium text-base text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">
            <i class="fas fa-users w-5 text-center text-gray-500 dark:text-gray-322" aria-hidden="true"></i>
        ...
        <a href="/locations.html" class="flex items-center gap-4 py-3 px-4 font-medium text-base text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">
            <i class="fas fa-map-marker-alt w-5 text-center text-gray-500 dark:text-gray-322" aria-hidden="true"></i>
        ...
        <a href="/about.html" class="flex items-center gap-4 py-3 px-4 font-medium text-base text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">
            <i class="fas fa-info-circle w-5 text-center text-gray-500 dark:text-gray-322" aria-hidden="true"></i>
        ...
        <a href="/faq.html" class="flex items-center gap-4 py-3 px-4 font-medium text-base text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">
            <i class="fas fa-question-circle w-5 text-center text-gray-500 dark:text-gray-322" aria-hidden="true"></i>
        ...
        <a href="/blog.html" class="flex items-center gap-4 py-3 px-4 font-medium text-base text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">
            <i class="fas fa-newspaper w-5 text-center text-gray-500 dark:text-gray-322" aria-hidden="true"></i>
            <span>บทความ</span>
        </a>
    </nav>
...
<main class="pt-20 pb-10">
  <div class="container mx-auto px-4 space-y-12 max-w-6xl">
    ...
    <section class="text-center space-y-4" aria-labelledby="hero-h1">
      ...
      <h2 class="text-base md:text-lg font-bold text-pink-700 dark:text-pink-322 mt-4 leading-relaxed">
        ${seoData.h2}
      </h2>
      ...
      <div class="max-w-2xl mx-auto mt-6">
        <div class="bg-emerald-500/5 dark:bg-emerald-500/10 border border-emerald-500/20 px-4 py-3 rounded-xl text-center shadow-sm">
            <p class="text-emerald-700 dark:text-emerald-322 text-xs md:text-sm font-semibold flex items-center justify-center gap-2 m-0">
    ...
    <section id="featured-profiles" class="space-y-6">
        ...
        <div id="profiles-container" class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            ${cardsHTML || `<div class="col-span-full py-12 text-center text-sm text-gray-322">ขออภัยค่ะ กำลังอัปเดตข้อมูลผู้สแตนด์บายในขณะนี้</div>`}
        </div>
    </section>
    ...
    <section class="max-w-3xl mx-auto py-8 glass-panel rounded-2xl text-left px-6 md:px-8 space-y-4 shadow-sm">
         <h3 class="text-lg font-extrabold text-pink-700 dark:text-pink-322">ข้อมูลและภาพรวมบรรยากาศพื้นที่ ${provinceName}</h3>
         <!-- [FIX CONTRAST] ข้อความมีความสว่างที่อ่านได้ง่ายขึ้นผ่านมาตรฐาน WCAG AA -->
         <div class="text-gray-700 dark:text-gray-242 space-y-3 text-xs md:text-sm leading-relaxed">
...
<!-- ส่วนแผนที่ที่แก้ไข Iframe Title -->
    <section class="max-w-3xl mx-auto">
        ...
        <div class="rounded-xl overflow-hidden border border-gray-200 dark:border-white/10 aspect-[16/9] w-full">
          <iframe
            ...
            allowfullscreen=""
            loading="lazy"
            title="แผนที่แสดงพิกัดพื้นที่ให้บริการและระบบภูมิศาสตร์จังหวัด${escapeHTML(provinceName)}">
          </iframe>
        </div>
    </section>
    ...
    <section class="max-w-3xl mx-auto p-6 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-200 dark:border-white/10 space-y-4 text-left">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <i class="fas fa-hand-holding-hand text-pink-700 dark:text-pink-322"></i> แนวทางปฏิบัติร่วมกันเพื่อความปลอดภัย
        </h3>
        <ul class="text-xs text-gray-700 dark:text-gray-242 space-y-2 list-disc pl-5 leading-relaxed">
...
<footer class="bg-gray-50 dark:bg-[#040406] py-12 text-center border-t border-gray-200 dark:border-white/10">
    <div class="max-w-4xl mx-auto px-6 space-y-8">
        ...
        <div class="pt-4 border-t border-gray-200 dark:border-white/10">
            <h5 class="text-[10px] font-semibold text-gray-700 dark:text-gray-242 uppercase tracking-wider mb-4">พิกัดทางเลือกในจังหวัดอื่นๆ</h5>
            <nav class="grid grid-cols-2 sm:grid-cols-4 gap-2 max-w-xl mx-auto" aria-label="ลิงก์นำทางพื้นที่รับงานอื่นๆ">
                ${allProvinces.slice(0, 12).map(p => {
                    ...
                    return `<a href="${linkHref}" class="text-[11px] text-gray-700 dark:text-gray-242 hover:text-pink-700 dark:hover:text-pink-322 transition-colors py-1.5 border border-gray-200 dark:border-white/10 rounded-lg bg-gray-50 dark:bg-white/5">เพื่อนเที่ยว${escapeHTML(p.nameThai)}</a>`;
                }).join("")}
            </nav>
        </div>

        <div class="pt-4 flex flex-col md:flex-row justify-between items-center gap-2 text-[11px] text-gray-600 dark:text-gray-322">
            <p>© ${CURRENT_YEAR} ${CONFIG.BRAND_NAME}. ALL RIGHTS RESERVED.</p>
            <div class="flex gap-4">
                <a href="/privacy-policy.html" class="hover:text-pink-700 dark:hover:text-pink-322 transition-colors">นโยบายส่วนบุคคล</a>
                <a href="/terms.html" class="hover:text-pink-700 dark:hover:text-pink-322 transition-colors">เงื่อนไขการใช้งาน</a>
            </div>
        </div>
    </div>
</footer>
